    ...
    <div className="flex flex-col bg-background min-h-full">
      ...
      <main className="flex-1 p-6 md:p-10 max-w-3xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="flex items-center gap-4 mb-6">
          ...
          <BookmarkButton targetType="event" targetRef={slug || ''} className="ml-auto flex h-9 w-9 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-colors hover:bg-secondary" />
        </div>
